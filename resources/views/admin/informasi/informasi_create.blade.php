                ...
                <div class="card-body p-4">
                    <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab"
                        ...
                        <div
                            ...
                            <div>
                                <form action="/informasi/create" novalidate method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                                            ...
                                            <div class="row g-3 needs-validation" novalidate>
                                                <div class="col-md-12">
                                                    <label for="judul_berita" class="form-label label">Judul</label>
                                                    <div class="position-relative">
                                                        <input type="text" name="judul_berita"
                                                            class="form-control h-58 ps-5" id="judul_berita"
                                                ...
                                                <div class="col-lg-6 d-flex form-group gap-1 flex-wrap">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="tanggal_berita" class="form-label label">Tanggal</label>
                                                        <div class="position-relative">
                                                            <input type="date" name="tanggal_berita"
                                                                class="form-control h-58 ps-5" id="tanggal_berita"
