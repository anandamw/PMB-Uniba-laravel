                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="body-font fw-bold fs-3 mb-2">{{ $totalKategori }}</h3>
            ...
            <div class="stats-box style-two card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="body-font fw-bold fs-3 mb-2">{{ $totalInformasi }}</h3>
                            <span>Total Infomasi</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-box style-two card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="body-font fw-bold fs-3 mb-2">{{ $totalBeasiswa }}</h3>
            ...
            <div class="stats-box style-two card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="body-font fw-bold fs-3 mb-2">{{ $totalJalurPenerimaan }}</h3>
                            <span>Total Jalur Penerimaan</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-box style-two card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="body-font fw-bold fs-3 mb-2"> {{ $totalTimPMB }}</h3>
                            <span>Total Tim PMB</span>
                        </div>
                    </div>
                </div>
            </div>
