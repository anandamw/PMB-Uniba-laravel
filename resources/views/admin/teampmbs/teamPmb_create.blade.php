        ...
        <div class="col-lg-12">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <form action="/team-pmb/create" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="nama_tim" class="form-control h-58 ps-5"
                                                id="validationCustom05" placeholder="Masukkan Nama Team ..." required>
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="jabatan_tim" class="form-control h-58 ps-5"
                                                id="validationCustom05" placeholder="Masukkan Jabatan Team ..." required>
                                            <div class="invalid-feedback">
