        ...
        <div class="col-lg-12">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <form action="/team-pmb/{{ $datas->id_team_pmb }}/edit" method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        <div
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel"
                                ...
                                <div class="row ">
                                    <div class="col-md-8">
                                        <label for="validationCustom05" class="form-label label">Nama
                                            Team</label>
                                        <div class="position-relative">
                                            <input type="text" name="nama_tim" class="form-control h-58 ps-5"
                                                id="validationCustom05" value="{{ $datas->nama_tim }}"
                                                placeholder="Masukkan Nama Team ..." required>
                                            <div class="invalid-feedback">
                                                Masukkan Nama Team dengan benar ...
                                            </div>
                                            <i class="ri-edit-2-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                                                style="top: 13px !important;"></i>
                                        </div>
                                        <label for="validationCustom05" class="form-label label">Jabatan
                                            Team</label>
                                        <div class="position-relative">
                                            <input type="text" name="jabatan_tim" class="form-control h-58 ps-5"
                                                id="validationCustom05" value="{{ $datas->jabatan_tim }}"
                                                placeholder="Masukkan Jabatan Team ..." required>
                                            <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                                                    <div class="product-upload">
                                                        ...
                                                        <input id="file-upload" name="foto_tim" onchange="readURL(this);"
                                                            type="file">
                                                    </div>
                                                </div>
                                            </div>
