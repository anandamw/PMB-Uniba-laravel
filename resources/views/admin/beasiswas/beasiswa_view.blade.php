                ...
                <div class="card-body p-4">
                    <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab"
                        ...
                        <div
                            ...
                            <h4 class="fw-semibold fs-18 mb-sm-0">Data Beasiswa</h4>
                                        ...
                                        <table class="table align-middle" id="myTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Deskripsi Beasiswa</th>
                                                        ...
                                                        <td>
                                                            <div class="dropdown action-opt">
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li>
                                                                        <a href="/beasiswa/{{ $item->token_beasiswa }}/detail"
                                                                    ...
                                                                    <li>
                                                                        <a href="/beasiswa/{{ $item->id_beasiswa }}/edit"
                                                                            class="dropdown-item">
                                                                    ...
                                                                    <li>
                                                                        <a href="#" class="dropdown-item"
                                                                            ...
                                                                            data-bs-target="#modal_delete{{ $item->id_beasiswa }}">
