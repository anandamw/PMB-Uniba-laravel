        ...
        <div class="col-lg-12">
            <div class="card bg-white border-0 rounded-10 mb-4">
                <div class="card-body p-4">
                    <form action="/beasiswa/{{ $datas->id_beasiswa }}/edit" method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        <div
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="nama_beasiswa" class="form-control h-58 ps-5"
                                                id="nama_beasiswa" value="{{ $datas->nama_beasiswa }}"
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="deskripsi_beasiswa" class="form-control h-58 ps-5"
                                                id="deskripsi_beasiswa" value="{{ $datas->deskripsi_beasiswa }}"
                                                placeholder="Masukkan Jabatan Beasiswa ..." required>
                                            <div class="invalid-feedback">
